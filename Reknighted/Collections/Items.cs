...
namespace Reknighted.Collections
{
    class Items
    {
        ...
        public static ArmorModel GoldenHelmet = new ArmorModel("Шлем с позолотой", "Наградной шлем для отличившихся ветеранов войны. Как нетрудно догадаться, лучшее применение его – сдать в ломбард. Золото же.", 450, 100, 15, PathTo("rare_helmet"));
